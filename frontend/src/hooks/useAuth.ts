...
export function useAuth(): UseAuthReturn {
  ...
  // Note: Does NOT redirect - the main page and other public pages should be accessible without login.
  // Redirect to login only happens when: (1) user visits protected route (middleware), or (2) user clicks Login/Report/Search
